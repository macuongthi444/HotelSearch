...
<body>
    <div id="logreg-forms">
        <form class="form-signin" action = "login" >
            ...
            <button class="btn btn-primary btn-block" type="button" id="btn-signup"><i class="fas fa-user-plus"></i> Đăng ký tài khooản mới</button>
            </form>
            ...
            <form action="signup" method ="post" class="form-signup">
                ...
                <button href="login" class="btn btn-primary btn-block" type="submit"><i class="fas fa-user-plus"></i> Đăng ký</button>
